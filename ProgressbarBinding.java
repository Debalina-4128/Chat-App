...
public final class ProgressbarBinding implements ViewBinding {
  ...
  private ProgressbarBinding(@NonNull LinearLayout rootView, @NonNull TextView tvProgressMessage) {
  ...
  public static ProgressbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProgressbarBinding((LinearLayout) rootView, tvProgressMessage);
    }
